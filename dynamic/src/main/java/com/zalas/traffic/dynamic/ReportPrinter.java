...
public class ReportPrinter {
    ...
    public void createReport() throws FileNotFoundException {
        ...
        out.println("<script> var size = 186;");
        ...
        for (int i = 0; i < dataSet.getDataRows().size(); i++) {
            ...
            out.println("<img src='traffic_cycles/" + (int) (dataSet.getDataRows().get(i).getOutput()) + ".png' />");
        ...
        System.out.println((int)(result*15));
        out.println("<img src='traffic_cycles/" + (int) (result * 15) + ".png' />");
